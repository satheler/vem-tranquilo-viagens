...
class TrajetoIntermunicipalSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('trechos')->insert(['trajeto_id' => 1, 'cidade_id' => 1, 'horarioSaida' => '21:30:00', 'horarioChegada' => '22:30:00', 'quilometragem' => 0, 'ordem' => 0]);
        DB::table('trechos')->insert(['trajeto_id' => 1, 'cidade_id' => 5, 'horarioSaida' => '22:45:00', 'horarioChegada' => '23:00:00', 'quilometragem' => 200.0, 'ordem' => 1]);
        DB::table('trechos')->insert(['trajeto_id' => 1, 'cidade_id' => 7, 'horarioSaida' => '23:59:00', 'horarioChegada' => '23:59:00', 'quilometragem' => 315.0, 'ordem' => 2]);
