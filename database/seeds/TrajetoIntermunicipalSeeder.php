...
class TrajetoIntermunicipalSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('trechos')->insert(['trajeto_id' => 1, 'cidade_id' => 7, 'horarioSaida' => null, 'horarioChegada' => null, 'quilometragem' => 315.0, 'ordem' => 2]);
        ...
        DB::table('trechos')->insert(['trajeto_id' => 2, 'cidade_id' => 7, 'horarioSaida' => null, 'horarioChegada' => null, 'quilometragem' => 500.0, 'ordem' => 1]);
        ...
        DB::table('trechos')->insert(['trajeto_id' => 3, 'cidade_id' => 7, 'horarioSaida' => null, 'horarioChegada' => null, 'quilometragem' => 530.0, 'ordem' => 3]);
    }
}
