...
@section('content')
    @include('users.partials.header', ['title' => __('Editar rodoviária')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <a href="{{ route('rodoviarias_inativas.index') }}" class="btn btn-sm btn-primary">{{ __('Voltar') }}</a>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('rodoviarias_inativas.update', $lista["rodoviaria"]) }}" autocomplete="off">
                            @csrf
                            @method('put')
