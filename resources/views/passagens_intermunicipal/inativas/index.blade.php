@extends('rodoviarias.index', ['title' => __('Rodoviárias inativas')])

@section('infos')
    <div class="card-header border-0">
        <div class="row align-items-center">
            <div class="col-8">
                <h3 class="mb-0">{{ __('Rodoviárias inativas') }}</h3>
            </div>
        </div>
    </div>
    <div class="col-12">
                            ...
                            <td align="center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <a class="dropdown-item" data-available-id="{{ $item->id }}" href="#">{{ __('Reativar') }}</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
