@extends('funcionario.index', ['title' => __('Gerenciar Funcionários')])
    ...
    <div class="card-header border-0">
        <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
                <a href="{{ route('gerir_funcionarios.create') }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Adicionar Funcionário"><i class="fas fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-12">
