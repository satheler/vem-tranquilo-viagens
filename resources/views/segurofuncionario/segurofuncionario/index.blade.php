@extends('segurofuncionario.index', ['title' => __('Lista de Seguros')])
    ...
    <div class="card-header border-0">
        <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
                <a href="{{ route('segurofuncionario.create') }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Adicionar Seguro"><i class="fas fa-plus"></i></a>
            </div>
        </div>
    </div>
