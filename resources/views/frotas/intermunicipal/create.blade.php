                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <a href="{{ route('intermunicipal.index') }}" class="btn btn-sm btn-primary">{{ __('Voltar') }}</a>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('intermunicipal.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{-- Check 1 --}}
                                        <div class="custom-control custom-radio mb-3">
                                            <input name="banheiro" class="custom-control-input" id="banheiro" type="radio" value=1>
                                            <label class="custom-control-label" for="banheiro">Sim</label>
                                        </div>
                                        {{-- Check 2 --}}
                                        <div class="custom-control custom-radio mb-3">
                                            <input name="banheiro" class="custom-control-input" id="banheiro2" type="radio" value=0>
