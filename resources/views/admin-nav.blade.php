...
<div class="search-bar">
    ...
    <input type="text" placeholder="Iniciar pesquisa...">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/admin">BusE-commerce</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        {{-- <div class="user-info">
            <div class="image">
                <img src="{{ asset('images/vendor/adminbsb-materialdesign/user-img-background.png')}}" width="48" height="48" alt="User" />
            </div>
        ...
        <div class="legal">
            <div class="copyright">
                &copy;2019 <a href="javascript:void(0);">BusE-commerce</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0
            </div>
